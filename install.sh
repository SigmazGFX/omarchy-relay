...
DEPS=(python-paho-mqtt python-cryptography python-textual python-gobject gtk4 libadwaita gstreamer gst-plugins-base gst-plugin-pipewire grim slurp figlet)
